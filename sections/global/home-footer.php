    ...
    <footer id="footer" class="txt-white">
        <div class="container">
            <div class="row footertop align-items-center flex-column-reverse flex-lg-row">
                <div class="col-12 col-lg-6 footertop-left-main">
                    ...
                    <div class="row mt-4 mb-5">
                        <div class="col-6 col-sm-6 footertopleft">
                            <h4>
                                Find Us On
                            </h4>
                ...
                <div class="col-12 col-lg-6 ps-auto ps-lg-3 ps-xl-5 footertop-right mb-4 mb-lg-0">
    ...
    <div id="cookie-policy">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-9 d-lg-flex column-gap-4 mb-3 mb-lg-0">
                ...
                <div class="col-12 col-lg-3">
                    <div class="d-flex cookietbns column-gap-2 justify-lg-content-end">
